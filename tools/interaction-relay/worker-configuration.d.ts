/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f10226eba8c6714c8f56aab00c5a08fc)
// Runtime types generated with workerd@1.20260815.1 2026-08-20 nodejs_compat
interface __BaseEnv_Env {
	MAILBOX_ID: "replace-with-random-mailbox-id";
	INTERACTION_MAILBOX: DurableObjectNamespace<import("./src/index").InteractionMailbox>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "InteractionMailbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAILBOX_ID">> {}
}
